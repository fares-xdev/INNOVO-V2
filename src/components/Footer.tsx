    ...
    <footer className="bg-white pt-6 pb-3 border-t border-border">
      <div className="container flex flex-col items-center gap-10">
        <div className="flex items-center gap-6">
          <a href="#" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors group">
            <svg className="w-6 h-6 transition-transform group-hover:scale-110" viewBox="0 0 320 512" fill="currentColor">
              <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
            </svg>
          </a>
          <a href="https://linkedin.com/in/username" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-foreground transition-colors group">
            <svg className="w-6 h-6 transition-transform group-hover:scale-110" viewBox="0 0 448 512" fill="currentColor">
