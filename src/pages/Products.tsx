  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <section className="page-hero !pb-0 !mb-0">
          <h1 className="page-hero-title">Products</h1>
        </section>

        <section className="w-full max-w-[1920px] mx-auto px-4 md:px-6 pb-4">
          ...
          <div className="flex flex-col items-start gap-4 mb-6">
            ...
            {!sidebarOpen && (
              ...
              <div className="flex flex-col gap-3 flex-1 w-full">
                <nav className="page-hero-breadcrumbs !justify-start !mb-0 !gap-2 md:!text-[16px]">
                  <Link to="/">Home</Link>
                  <span className="separator"><ChevronRight className="w-4.5 h-4.5 stroke-[1.5]" /></span>
                  {currentPage > 1 ? (
                    <>
