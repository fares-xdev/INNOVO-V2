...
final class Plugin {
	...
	private function define_hooks() {
		...
		// 3.12 Social Links CPT
		$social_links_cpt = new \ProjectCore\PostTypes\SocialLinks();
		$this->loader->add_action( 'init', $social_links_cpt, 'register_post_type' );

		$social_links_meta = new \ProjectCore\Admin\SocialLinksMeta();
		$this->loader->add_action( 'add_meta_boxes', $social_links_meta, 'add_meta_boxes' );
		$this->loader->add_action( 'save_post', $social_links_meta, 'save_metadata' );
		$this->loader->add_action( 'rest_api_init', $social_links_meta, 'register_rest_fields' );
